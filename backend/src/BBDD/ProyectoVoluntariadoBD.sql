...
CREATE TABLE ORGANIZACION(
    CODORG INT IDENTITY(1,1) NOT NULL,
    ...
    CONSTRAINT CK_ORGANIZACION_TIPO_ORG CHECK(TIPO_ORG IN ('ONG', 'FUNDACIÓN', 'ASOCIACIÓN', 'ENTIDAD PÚBLICA', 'OTRA')),
    ...
    CONSTRAINT CK_ORGANIZACION_TELEFONO CHECK(TELEFONO LIKE '[0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]'),
    CONSTRAINT CK_ORGANIZACION_CORREO CHECK(CORREO LIKE '%@%.%'),
    CONSTRAINT CK_ORGANIZACION_ESTADO CHECK(ESTADO IN ('ACTIVO', 'SUSPENDIDO', 'PENDIENTE'))
)
GO
...
CREATE TABLE ACTIVIDAD(
    ...
    CONSTRAINT CK_ACTIVIDAD_ESTADO CHECK(ESTADO IN ('PENDIENTE', 'EN_PROGRESO', 'DENEGADA', 'FINALIZADA'))
)
GO
...
CREATE TABLE VOLUNTARIO(
    CODVOL INT IDENTITY(1,1) NOT NULL,
    ...
    CONSTRAINT CK_VOLUNTARIO_TELEFONO CHECK(TELEFONO LIKE '[0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]'),
